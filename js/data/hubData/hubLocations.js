export const HUB_LOCATIONS = [
    ...
    {
        id: 'tavern_recruits',
        name: 'Поток авантюристов',
        description: 'Люди, подающиеся в подвижные шахты из героизма или жажды знаний. Ну, или безысходности...',
    ...
    },
    {
        id: 'bazaar',
        name: 'Базар',
        description: 'Сбыт добычи и покупка припасов для вылазки.',
        action: 'OPEN_SHOP'
    },
    {
